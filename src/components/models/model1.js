            ...
            <div className="model-TextColumns__3">
                ...
                <article>
                    ...
                    <div className="left box" style={{fontSize: "15px", fontFamily: "happy-times-NG_regular_master_web"}}>
                        ...
                        Referring to the early history of the museum where it functioned as a model museum; a place with the social purpose of inspiring craftsmen by presenting good models or forms of design, the museum is a place of constant change – resonating with the events of the outside world.
                    </div>
                    <br/><br/>
