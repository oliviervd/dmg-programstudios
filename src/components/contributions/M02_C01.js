    ...
    return(
        <div className="rowScrollMain">
            ...
            <div className="grid--3_4_3">
                ...
                <div>
                    <h1 className="center background__white"  style={{height: "auto", padding: "80px"}}> THE MUSEUM AND ITS EXPANDED (DIGITAL) SPACE: FROM THE REPRESENTATIONAL TO THE PERFORMATIVE</h1>
                    <div className="grid--4_2_4">
                        <div className="background__transparent"/>
                        <p className="center background__white" style={{fontSize: "16px", fontFamily: "lineal", borderBottom: "2px var(--main__green) solid", borderTop: "2px var(--main__green) solid"}}>ESSAY</p>
                        <div className="background__transparent"/>
                    </div>
