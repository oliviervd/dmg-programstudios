...
const NewItems = (props) => {
    ...
    const newItems_december = ["1987-0889", "1987-0841", "1995-0034", "1997-0010", "2000-0047_0-5", "DES.1996.04", "1990-0005", "1996-0024", "FH-0096_0-2", "FH-0103", "1413", "1433", "1992-0029_0", "1977-0029", "3150_A", "3150_B", "1997-0011", "2018-0371_0"]
    const [newItems, setNewItems] = useState(newItems_december)
                        ...
                        <div>
                            <div>
                                <div className={"grid--even_10"}>
                                    <p className={"HeaderLink"} onClick={()=>{setNewItems(newItems_november)}}>december 2023</p>
